...
import { FiEdit, FiTrash, FiSearch, FiDollarSign } from "react-icons/fi"; // Adicionado FiDollarSign
...
import AcertoContaModal from "../../components/common/AcertoContaModal"; // Adicionado a importação do novo Modal
import './styles.css';
                    ...
                    <DataTable
                        ...
                        actions={(item) => (
                            <div className="action-buttons">
                                ...
                                {/* O NOVO BOTÃO DE ACERTO DE CONTAS VAI AQUI */}
                                <IconButton
                                    icon={FiDollarSign}
